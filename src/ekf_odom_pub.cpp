...
const double LEFT_WHEEL_RADIUS = 0.193;				   	   // Left wheel radius in meters
...
const double LEFTWHEEL_OFFSET = 0.03;					   // Offset of left wheel in meters (positive is to the forward)
